function [output16] = innersolve16(n,a)
            ...
            while p==1
                ...
                if n-(solve*u)>=zeorone
                    if n-(solve*u)>=zeorone
                        ...
                        if tt==15
                            is=innersolve15(n-(solve*u),g(i,:));
                          end
                        
                        if tt==14
                            is=innersolve14(n-(solve*u),g(i,:));
                          end
                        
                        if tt==13
                            is=innersolve13(n-(solve*u),g(i,:));
                          end
                        
                         if tt==12
                            is=innersolve12(n-(solve*u),g(i,:));
                          end
                        
                        if tt==11
                            is=innersolve11(n-(solve*u),g(i,:));
                          end
                        ...
                        if n-(solve*u)==0
                         ...
                         if tt==15
                            output15(o(tt):dd+o(tt)-1,:)=[repmat(g(i,:),dd,u),is];
                            neshan(tt)=1;
                        end
                        
                          if tt==14
                            output14(o(tt):dd+o(tt)-1,:)=[repmat(g(i,:),dd,u),is];
                            neshan(tt)=1;
                        end
                        
                        if tt==13
                            output13(o(tt):dd+o(tt)-1,:)=[repmat(g(i,:),dd,u),is];
                            neshan(tt)=1;
                        end
                        
                        if tt==12
                            output12(o(tt):dd+o(tt)-1,:)=[repmat(g(i,:),dd,u),is];
                            neshan(tt)=1;
                        end
                        
                         if tt==11
                            output11(o(tt):dd+o(tt)-1,:)=[repmat(g(i,:),dd,u),is];
                            neshan(tt)=1;
                        end
...
output16=[output1;output2;output3;output4;output5;output6;output7;output8;output9;output10;output11;output12;output13;output14;output15];
end
